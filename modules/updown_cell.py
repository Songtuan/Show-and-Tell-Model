...
class UpDownCell(nn.Module):
    ...
    def _average_image_features(
        ...
        # since the features in padding boxes are all zero, the sum of these features would
        # be zero and hence, we can use this condition to determine which boxes are padding boxes
        # shape: (batch_size, num_boxes)
